import { Phone, Globe, Smartphone } from 'lucide-react';
      ...
      <main className="max-w-md mx-auto px-6 py-16">
        <div className="bg-[#242830] border border-gray-700 rounded-lg overflow-hidden">
          <div className="bg-[#2a3040] px-8 py-6 flex items-center gap-3 border-b border-gray-700">
            ...
            <h1 className="text-white">{t('smsVerification')}</h1>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="flex justify-center">
                <InputOTP maxLength={6} value={otp} onChange={setOtp}>
                  <InputOTPGroup>
                    <InputOTPSlot index={0} className="bg-[#1a1d23] border-gray-600 text-white" />
                    <InputOTPSlot index={1} className="bg-[#1a1d23] border-gray-600 text-white" />
                    <InputOTPSlot index={2} className="bg-[#1a1d23] border-gray-600 text-white" />
                    <InputOTPSlot index={3} className="bg-[#1a1d23] border-gray-600 text-white" />
                    <InputOTPSlot index={4} className="bg-[#1a1d23] border-gray-600 text-white" />
                    <InputOTPSlot index={5} className="bg-[#1a1d23] border-gray-600 text-white" />
                  </InputOTPGroup>
                </InputOTP>
              </div>
              ...
              <Button 
                ...
                className="w-full bg-[#d4af37] hover:bg-[#c09d2e] text-black py-6 rounded-full transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {t('verifyCode')}
              </Button>

              <div className="text-center">
                <button type="button" className="text-[#d4af37] hover:underline text-sm">
                  {t('resendCode')}
                </button>
              </div>
            </form>
