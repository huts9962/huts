      ...
      <main className="max-w-md mx-auto px-6 py-16">
        ...
        <div className="bg-[#242830] border border-gray-700 rounded-lg overflow-hidden">
          <div className="bg-[#2a3040] px-8 py-6 flex items-center gap-3 border-b border-gray-700">
            ...
            <h1 className="text-white">{t('loginToInternetBanking')}</h1>
          </div>
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="pt-4 space-y-3 text-center">
              <a href="#" className="block text-[#d4af37] hover:underline">
                {t('forgotPassword')}
              </a>
              <a href="#" className="block text-gray-400 hover:text-gray-300">
                {t('troublesLogin')}
              </a>
            </div>
          </div>
        ...
        {/* Security Notice */}
        <div className="mt-6 bg-[#242830]/50 border border-gray-700 rounded-lg p-4">
          <p className="text-gray-400 text-sm text-center">
            <Lock className="w-4 h-4 inline-block mr-1 mb-1" />
            {t('sslEncryption')}
          </p>
        </div>
      </main>
